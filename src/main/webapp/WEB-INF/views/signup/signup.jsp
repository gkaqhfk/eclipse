...
<html>
	...
	<body>
		<section id="container">
			<form action="/signup/signup.do" name="frm" id="frm" method="post">
				<div class="form-group has-feedback">
					<label class="control-label" for="username">아이디</label>
					<input class="form-control" type="text" id="username" name="username" />
				</div>
				<div class="col-12">
					<button type="button" class="btn btn-primary" id="idck">id 중복확인</button>
				</div>
				<div class="form-group has-feedback">
				...
				<div class="form-group has-feedback">
					...
					<input class="form-control" type="textarea" id="Introducetext" name="Introducetext" />
				</div>


				<div class="form-group has-feedback">
					<button class="btn btn-success" type="submit" id="submit" onclick="return DosignUp();">회원가입</button>
